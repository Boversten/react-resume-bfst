...
import {interestsItems, SectionId} from '../../data/data';
import {InterestsItem} from '../../data/dataDef';
import useDetectOutsideClick from '../../hooks/useDetectOutsideClick';
import Section from '../Layout/Section';

const Interests: FC = memo(() => {
  return (
    <Section className="bg-neutral-800" sectionId={SectionId.Interest}>
      <div className="flex flex-col gap-y-8">
        <h2 className="self-center text-xl font-bold text-white"> ... and My Interests</h2>
...
const ItemOverlay: FC<{item: InterestsItem}> = memo(({item: {url, title, description}}) => {
